                            ...
                            success: function(data){
                                try{
                                    if(data.status == "success"){
                                        notificaciones = '<li style="font-size: 18px;color:red;background-color:yellow"><h5>ALERTAS DE VENCIMIENTOS DE PÓLIZAS DE CONTRATOS</h5></li>';
                                        ...
                                        notificaciones += '<p><a style="font-size: 18px;color:BLUE" target="_blank" href="/pdf/panel_contracts5">REPORTE DE VENCIMIENTOS PDF</a></p>'
                                        notificaciones += '<p><a style="font-size: 18px;color:GREEN" target="_blank" href="/contracts/exportarexcel6">REPORTE DE VENCIMIENTOS EXCEL</a></p>'
