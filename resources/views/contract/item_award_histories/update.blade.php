            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('item_award_histories.index', $item->id) }}">Endoso: {{ $endoso->number_policy }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    {{-- <form method="POST" action="{{ route('item_award_histories.update', $item->id) }}"> --}}
                                        @csrf
                                        <div class="container">
                                            <h3 style="text-align: center;">Editar Endoso</h3>
                                            {{-- <br>
            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            {{-- <a href="{{ route('items.show', $item->id) }}">Llamados {{ $item->number_year }}</a> --}}
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Modificar Póliza al Llamado Nº {{ $item->number_year }}</h5>
                                    <br>
                                    <label id="fecha_actual" name="fecha_actual"  style="font-size: 20px;color: #FF0000;float: left;" for="fecha_actual">{{ Carbon\Carbon::now()->format('d/m/Y') }}</label>
                                    {{-- <label style="font-size: 20px;color: #FF0000;float: left;">FECHA: </label> --}}
                                ...
                                <div class="card-block">
                                        {{-- <form method="POST" action="{{ route('items.items.update', [$item->id, $item->id]) }}"> --}}
                                        @csrf
                                        @method('PUT')
                                        ...
                                        {{-- <div class="col-sm-12">
                                            <div class="form-group text-center">
                                                @if (in_array($item->item_state_id, [1,2]))
                                                    <a href="{{ route('items.files.create', $item->id) }}" class="btn btn-danger">Cargar PDF Póliza</a>
                                                @endif
                                            </div>
                                        </div> --}}
                                        <div class="col-sm-12">
